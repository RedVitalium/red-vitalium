...
export const dass21Questions = [
  { id: 1, text: "Me costó mucho relajarme", subscale: "S" },
  { id: 2, text: "Me di cuenta que tenía la boca seca", subscale: "A" },
  { id: 3, text: "No podía sentir ningún sentimiento positivo", subscale: "D" },
  { id: 4, text: "Se me hizo difícil respirar (respirar rápido, sin hacer ejercicio)", subscale: "A" },
  { id: 5, text: "Se me hizo difícil tomar la iniciativa para hacer cosas", subscale: "D" },
  { id: 6, text: "Reaccioné exageradamente en ciertas situaciones", subscale: "S" },
  { id: 7, text: "Sentí que mis manos temblaban", subscale: "A" },
  { id: 8, text: "Sentí que tenía muchos nervios", subscale: "S" },
  { id: 9, text: "Estaba preocupado por situaciones en las cuales podía tener pánico o en las que podría hacer el ridículo", subscale: "A" },
  { id: 10, text: "Sentí que no tenía nada por lo que vivir", subscale: "D" },
  { id: 11, text: "Noté que me agitaba fácilmente", subscale: "S" },
  { id: 12, text: "Se me hizo difícil relajarme", subscale: "S" },
  { id: 13, text: "Me sentí triste y deprimido", subscale: "D" },
  { id: 14, text: "No toleré nada que me impidiera seguir con lo que estaba haciendo", subscale: "S" },
  { id: 15, text: "Sentí que estaba a punto de entrar en pánico", subscale: "A" },
  { id: 16, text: "No me pude entusiasmar por nada", subscale: "D" },
  { id: 17, text: "Sentí que valía muy poco como persona", subscale: "D" },
  { id: 18, text: "Sentí que estaba muy irritable", subscale: "S" },
  { id: 19, text: "Sentí los latidos de mi corazón a pesar de no haber hecho ningún esfuerzo físico", subscale: "A" },
  { id: 20, text: "Tuve miedo sin razón", subscale: "A" },
  { id: 21, text: "Sentí que la vida no tenía ningún sentido", subscale: "D" },
];
