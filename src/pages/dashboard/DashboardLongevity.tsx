...
export default function DashboardLongevity() {
  ...
  const metrics = [
    ...
    { key: "hr", title: "Frecuencia Cardíaca", subtitle: "Promedio del día (bpm)", value: longevityData.heartRate.value, unit: "bpm", target: "60-100", change: longevityData.heartRate.change, status: longevityData.heartRate.value > 0 ? (longevityData.heartRate.value >= 60 && longevityData.heartRate.value <= 100 ? "optimal" : "warning") : "warning", icon: <Heart className="h-5 w-5" />, metric: "heart_rate" as MetricType, label: "FC Promedio", demoText: "Frecuencia cardíaca promedio en rango normal. Valores entre 60-100 bpm son saludables en reposo." },
    { key: "spo2", title: "SpO2 Nocturno", subtitle: "Saturación de oxígeno (%)", value: longevityData.spo2.value, unit: "%", target: "> 95%", change: longevityData.spo2.change, status: getStatus(longevityData.spo2.value, 95), icon: <Activity className="h-5 w-5" />, metric: "spo2" as MetricType, label: "SpO2", demoText: "Saturación de oxígeno en rango normal. Valores por debajo de 95% requieren atención médica." },
  ];
