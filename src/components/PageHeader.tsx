...
export function PageHeader({
  ...
  return (
    <header className="sticky top-0 z-[60] bg-background border-b border-border/50 before:absolute before:top-[-100px] before:left-0 before:right-0 before:h-[100px] before:bg-background" style={{ isolation: 'isolate' }}>
